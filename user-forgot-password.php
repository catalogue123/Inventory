...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM tblemployee WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update tblemployee set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
<head>
    ...
    <title>Inventory Management System | Password Recovery </title>
