...
$id=$_GET['del'];
// print_r($id);exit;
$sql = "delete from tblvendor  WHERE id=:id";
$query = $dbh->prepare($sql);
$query -> bindParam(':id',$id, PDO::PARAM_INT);
$query -> execute();
$_SESSION['delmsg']="Vendor deleted";
...
<head>
    ...
    <title>Inventory Management System | Manage Vandor</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Manage Vendor</h4>
    </div>
     <div class="row">
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href=<?php echo BASE_URL."/edit-vendor.php?venid="?><?php echo htmlentities($result->id);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
                                          <a href=<?php echo BASE_URL."/manage-vendor.php?del="?><?php echo htmlentities($result->id);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
