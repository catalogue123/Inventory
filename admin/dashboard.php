...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Inventory Management System | Admin Dash Board</title>
...
<?php 
$sql ="SELECT is_id from issue ";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$issue_num=$query->rowCount();
?>

                            <h3><?php echo htmlentities($issue_num);?></h3>
                          Raised Issues
                        </div>
                    </div>
               <div class="col-md-3 col-sm-3 col-xs-6">
