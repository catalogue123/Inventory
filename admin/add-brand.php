...
$status=$_POST['status'];
$vendor=$_POST['vendor'];
$sql="INSERT INTO  tblbrand(brand_name,is_active,vendor_id) VALUES(:category,:status,:vendor)";
...
<head>
    ...
    <title>Inventary Management System | Add Brands</title>
...
<?php 
$status=1;
$sql1 = "SELECT * from  tblvendor where is_active=:status";
